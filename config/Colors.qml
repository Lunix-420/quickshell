...
Singleton {
    ...
    readonly property string surface: surface0
    readonly property string textDark: base
    readonly property string accentRed: red
    // Catppuccin Macchiato palette (26 colors)
